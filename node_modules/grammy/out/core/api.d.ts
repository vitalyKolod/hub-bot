...
export declare class Api<R extends RawApi = RawApi> {
     ...
     */
    editEphemeralMessageText(chat_id: number | string, receiver_user_id: number, ephemeral_message_id: number, text: string, other?: Other<R, "editEphemeralMessageText", "chat_id" | "receiver_user_id" | "ephemeral_message_id" | "text">, signal?: AbortSignal): Promise<true>;
    /**
     ...
     */
    editEphemeralMessageMedia(chat_id: number | string, receiver_user_id: number, ephemeral_message_id: number, media: InputMediaWithoutUpload, other?: Other<R, "editEphemeralMessageMedia", "chat_id" | "receiver_user_id" | "ephemeral_message_id" | "media">, signal?: AbortSignal): Promise<true>;
    /**
