...
export declare class Menu<C extends Context = Context> extends MenuRange<C> implements MiddlewareObj<C>, InlineKeyboardMarkup {
    ...
    protected parent: string | undefined;
    protected index: Map<string, Menu<C>>;
    protected readonly options: Required<MenuOptions<C> & {
     ...
     */
    protected render(ctx: C): Promise<InlineKeyboardButton[][]>;
    /**
     ...
     */
    protected prepare(payload: Record<string, unknown>, ctx: C): Promise<void>;
