...
const PAGES = [
  `1/5\n\n` +
    ...
    `Администрация ХАБа будет признательна, если вы сможете сделать добровольное пожертвование именно криптовалютой, так как такие переводы привлекают меньше внимания банковских работников к нашим системам, помогают избежать проверок и блокировок по 115-ФЗ, а также налоговых издержек.`,
